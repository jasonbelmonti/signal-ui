...
export const CyberGlassPrototype: Story = {
  parameters: {
    layout: "fullscreen",
  },
    ...
    <Space direction="vertical" size={18} style={{ width: "100%" }}>
      ...
      >
        <Space direction="vertical" size={14} style={{ width: "100%" }}>
          ...
          <Typography.Paragraph style={{ margin: 0 }}>
            This story exists to validate the reticle shell itself: point-open, collapsed seam,
            and hide transitions without the glass prototype layered on top.
          </Typography.Paragraph>
